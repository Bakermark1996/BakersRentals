...
namespace BakersRentals.Controllers
{
    public class RentalsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Location,Bedrooms,Bathrooms,StartDate,EndDate,RentalNotes")] Rental rental)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Location,Bedrooms,Bathrooms,StartDate,EndDate,RentalNotes")] Rental rental)
        {
            if (id != rental.Id)
            {
                return NotFound();
